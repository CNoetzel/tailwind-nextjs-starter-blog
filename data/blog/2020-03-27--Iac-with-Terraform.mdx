...
<NoticeBox
  ...
  content={[
    {
      text:
        'Terraform supports you at this point, as it automatically creates the corresponding TXT record via <b>Route 53</b> in the blogs hosted zone. This is not so easily possible via <b>AWS Cloudformation</b>.',
    },
  ]}
/>
